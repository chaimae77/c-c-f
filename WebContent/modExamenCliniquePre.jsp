				...
				<div class="row">
					...
					<div class="card">
							...
							<div class="card-icon" style="float: none !important;"><h4>Modification de l'examen Clinique pré-opératoire</h4>
								...
								<form role="form" action="modExamenCliniquePreTrait.chu" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="dateexamen" for="">Date d'examen:</label>
                                                  ...
                                                  <input type="text" name="dateexamen" placeholder="<%=dateFormatee %>" class="form-control" id="dateexamen">
                                                </div>
                                         
											<div class="form-group">
                                                <label for="poids" for="" >poids</label>
                                                <input type="text" class="form-control" name="poids" id="poids" placeholder="<%=examen.getPoids() %>">
                                            </div>
											<div class="form-group">
                                                <label for="taille" for="">Taille</label>
                                                <input type="text" class="form-control" name="taille" id="taille" placeholder="<%=examen.getTaille() %>">
                                            </div>
											<div class="form-group">
                                                <label for="oms" for="" >OMS</label>
                                                <input type="text" class="form-control" name="oms" id="oms" placeholder="<%=examen.getOMS() %>">
                                            </div>
											<div class="form-group">
                                                <label for="imc" for="">IMC</label>
                                                <input type="text" class="form-control" name="imc" id="imc" placeholder="<%=examen.getIMC() %>"  >
                                            </div>			
										</div>
										</div>
									<div class="row">
