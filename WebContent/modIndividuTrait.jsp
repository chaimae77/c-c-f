												...
												<div class="col-md-6 ">
													...
													<div class="form-group">
														<input type="hidden" class="form-control" name="idIndividu"
															value="<%=ind.getId()%>" style="width:250px">
													</div>
													<div class="form-group">
														<input type="hidden" class="form-control" name="famille"
															value="<%=ind.getFamille().getId()%>" style="width:250px">
													</div>
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="prenom"
																id="prenom" placeholder="<%=ind.getPrenom() %>"
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="nom" id="nom"
																placeholder="<%=ind.getNom() %>" style="width:250px"
																required>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="origine"
																id="origine" placeholder="<%=ind.getOrigine() %>"
																style="width:250px" required>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="ville"
																id="ville" placeholder="<%=ind.getVille() %>"
																style="width:250px" required>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="adresse"
																id="adresse" placeholder="<%=ind.getAdresse() %>"
																style="width:250px" required>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="tel1"
																id="tel1" placeholder="<%=ind.getTel1() %>"
																style="width:250px" required>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="tel2"
																id="tel2" placeholder="<%=ind.getTel2() %>"
																style="width:250px" required>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															<select class="form-control" name="couverture"
																...
																<!-- <option><%=CouvertureMedicale.Prive %></option> -->
